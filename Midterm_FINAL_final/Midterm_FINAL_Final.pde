...
void draw()
{
  ...
  else if (first ==1)
  {
    ...
    text("(1)", width/4 +30,height/2+height/4);
    text("(2)", width - width/4 -30,height/2+height/4);
  ...
  else if (choice1==1&& choice2==0) 
  {
    ...
    text("(1)", width/4 +30,height/2+height/4);
    text("(2)", width - width/4 -30,height/2+height/4);
    image(winter,width/6,height/2.5,200,200);
    image(summer,width - width/2.5,height/2.5,200,200);
  } 
  ...
  else if (choice1==2&& choice2==0) 
  {
    ...
    text("(1)", width/4 +30,height/2+height/4);
    text("(2)", width - width/4 -30,height/2+height/4);
    image(coffee,width/6,height/2.5,200,200);
    image(tea,width - width/2.5,height/2.5,200,200);
  }
  //choice == "2"
  else if (choice1 ==1 && choice2==1&& choice3==0)
  {
    ...
    text("(1)", width/4 +30,height/2+height/4);
    text("(2)", width - width/4 -30,height/2+height/4);
    image(active,width/6,height/2.5,200,200);
    image(lazy,width - width/2.5,height/2.5,200,200);
  }
    ...
    text("(1)", width/4 +30,height/2+height/4);
    text("(2)", width - width/4 -30,height/2+height/4);
    image(night,width/6,height/2.5,200,200);
    image(day,width - width/2.5,height/2.5,200,200);
    }
  else if (choice1 ==2 && choice2==1&& choice3==0)
  {
    ...
    text("(1)", width/4 +30,height/2+height/4);
    text("(2)", width - width/4 -30,height/2+height/4);
    image(dark,width/6,height/2.5,200,200);
    image(light,width - width/2.5,height/2.5,200,200);
  }
    ...
    text("(1)", width/4 +30,height/2+height/4);
    text("(2)", width - width/4 -30,height/2+height/4);
    image(drama,width/6,height/2.5,200,200);
    image(comedy,width - width/2.5,height/2.5,200,200);
    }
